...
- [Exact Boolean queries and witnesses](boolean-queries.md) — satisfiability, implication/equivalence proofs, exact simplification, deterministic witnesses, and explicit incomplete-result semantics.
